...
public class ProductoController {
    ...
    public ResponseEntity<byte[]> downloadTemplate() throws java.io.IOException {
        ...
        header.setContentType(new org.springframework.http.MediaType("application", "force-download"));
        header.set(org.springframework.http.HttpHeaders.CONTENT_DISPOSITION,
                "attachment; filename=productos_template.xlsx");
        return new ResponseEntity<>(stream.toByteArray(), header, org.springframework.http.HttpStatus.CREATED);
    }
}
